---
description: Agente Frontend — Etapa 3 do fluxo de desenvolvimento. Cria componentes, formulários, rotas e menu a partir do output do Backend.
---

# AGENTE 3 — FRONTEND

> **Este workflow só deve ser executado APÓS ter o output do Agente Backend (`/backend`).**
...
2. O output completo do Agente Backend
...
Entregue sempre neste formato para o Agente de Qualidade (o usuário vai colar na próxima etapa usando `/qualidade`):
