---
description: Agente Backend — Etapa 2 do fluxo de desenvolvimento. Cria migration, types, schemas Zod, server actions e hooks TanStack Query.
---

# AGENTE 2 — BACKEND

> **Este workflow só deve ser executado APÓS ter o output do Agente Arquiteto (`/arquiteto`).**
...
2. O output completo do Agente Arquiteto
...
Entregue sempre neste formato para o Agente Frontend (o usuário vai colar na próxima etapa usando `/frontend`):
